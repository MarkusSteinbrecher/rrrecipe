...
async function fetchYouTubeTranscript(videoId, languages = ["en"]) {
...
async function fetchYouTubeWatchHtml(videoId) {
  ...
  let response = await fetch(url, {
    headers: youtubeTranscriptHeaders(),
  });
...
function assertYouTubePlayable(player, videoId) {
...
function captionUrl(baseUrl, format) {
...
function parseJson3CaptionSegments(data) {
  return (data.events ?? [])
...
function parseXmlCaptionSegments(xml) {
  const segments = [];
